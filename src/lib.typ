...
/// Draw a dumper between two points.
///
...
/// - width (float, ratio): The width of the dumper.
/// - r (float, ratio): The width of the pushing block.
/// - inverse (boolean): Invert the direction of the dumper.
/// - name (string): The name of the group.
/// - style (cetz.style): The style.
/// -> none
#let dumper(a, b: none, width: 60%, r: 90%, inverse: false, name: none, ..style) = {
    import cetz.draw: *
    if b == none {
      b = (a.at(0) + 0.7, a.at(1))
    }
    ...
    group(name: name, ctx => {line(
      ...
      (a.at(0) - vec-cross.at(0), a.at(1) - vec-cross.at(1)),
      (b.at(0) - vec-cross.at(0), b.at(1) - vec-cross.at(1)), ..style
    )

    // pushing block
    line(
      ((a.at(0) + b.at(0)) / 2 + vec-cross.at(0) * r, (a.at(1) + b.at(1)) / 2 + vec-cross.at(1) * r),
      ((a.at(0) + b.at(0)) / 2 - vec-cross.at(0) * r, (a.at(1) + b.at(1)) / 2 - vec-cross.at(1) * r), ..style
    )
